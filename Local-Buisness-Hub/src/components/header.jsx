...
export default function Header() {
    // now seacrh term mai voh sare query params hmare jayege string format mai isliye by default empty string diya hain
        ...
        <header className='bg-slate-300 shadow-md'>
            <div className='flex justify-between items-center p-3 max-w-6xl mx-auto '>
                ...
                <h1 className='font-bold text-xl flex flex-wrap'>
                    <span className='text-slate-500'>LocalBuisness</span>
